...
ADMINS = [("""Palo Alto Networks Automation""", "admin@example.com")]
...
SOCIALACCOUNT_ADAPTER = "django_project.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "django_project.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "CDSS Certificate Remediation API",
    "DESCRIPTION": "Documentation of API endpoints of CDSS Certificate Remediation",
    "VERSION": "1.0.0",
